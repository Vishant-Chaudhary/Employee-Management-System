...
const AcceptTask: React.FC<Props> = ({ task, employeeId }) => {
    const dispatch = useDispatch();

    const markCompleted = () => {
        dispatch({
            type: "tasks/updateTaskRequest",
            payload: { employeeId, taskId: task.id, updates: { completed: true, active: false } },
        });
    };
    ...
    const markFailed = () => {
        dispatch({
            type: "tasks/updateTaskRequest",
            payload: { employeeId, taskId: task.id, updates: { failed: true, active: false } },
        });
    };
